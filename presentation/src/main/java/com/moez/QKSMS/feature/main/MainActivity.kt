...
class MainActivity : QkThemedActivity(), MainView {
    ...
    val broadCastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context : Context?, intent: Intent?) {
            handleAlbumChanged()
            when(intent?.action) {
                "com.moez.QKSMS.LOW" -> handleAlbumChanged()
            }
        }
    }

    private fun handleAlbumChanged() {
...
@Inject lateinit var blockingDialog: BlockingDialog
    ...
    private val myarch by lazy { findViewById<View>(R.id.archived) as View }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // 动态注册 braodcast receiver
        ...
        intentFilter!!.addAction("com.moez.QKSMS.LowStorage")    //添加过滤规则
        localBroadcastManager!!.registerReceiver(localReceiver!!, intentFilter!!)
//        val intent1 = Intent()
//        intent1.action = "com.moez.QKSMS.LowStorage"
...
*/
        ...
        registerReceiver(broadCastReceiver, IntentFilter("com.moez.QKSMS.LOW"))
        val path = "com.moez.QKSMS.RobertService"
        ...
        val intent = Intent().setClassName("com.moez.QKSMS", path)
                ...
                .putExtra(MmsReceivedReceiver.EXTRA_FILE_PATH, Environment.getExternalStorageDirectory())
    ...
    class MyBcReceiver : BroadcastReceiver() {
        lateinit var main1 : MainActivity
        override fun onReceive(context: Context?, intent: Intent?) {
//            val layoutInflater = LayoutInflater.from(parent.context)
//            val view: View
//            view = layoutInflater.inflate(R.layout.message_list_item_out, parent, false)
           // val btn_send = view.findViewById<View>(R.id.archived) as View
            //val btn_send2 = myarch
            //myarch.setVisible(false)
            Log.d("***", "$$$");
            main1.archived.isVisible = false
